...
const HeroSection = () => {
  return (
    <section className="relative w-full min-h-screen flex flex-col items-center justify-center overflow-hidden font-poppins px-3 sm:px-6 lg:px-10 py-6 sm:py-10">
      {/* Background Layers */}
      <img
      ...
      <img
        ...
        alt="Gedung Tengah"
        className="absolute left-1/2 bottom-3 sm:bottom-6 md:bottom-8 lg:bottom-12 -translate-x-1/2 z-10 w-[230px] xs:w-[280px] sm:w-[350px] md:w-[460px] lg:w-[570px] xl:w-[680px]"
      />
      ...
      <img
        ...
        alt="Gedung Kiri"
        className="absolute bottom-0 left-0 z-0 w-[110px] xs:w-[150px] sm:w-[200px] md:w-[260px] lg:w-[330px] xl:w-[410px]"
      />
      ...
      <img
        ...
        alt="Gedung Kanan"
        className="absolute bottom-0 right-0 z-0 w-[110px] xs:w-[150px] sm:w-[200px] md:w-[260px] lg:w-[330px] xl:w-[410px]"
      />
      ...
      <img
        ...
        alt="Awan Kiri"
        className="absolute top-2 xs:top-4 sm:top-6 md:top-8 left-0 w-[90px] xs:w-[130px] sm:w-[170px] md:w-[220px] lg:w-[260px] opacity-70 sm:opacity-80 animate-[cloudMove_30s_linear_infinite]"
      />
      ...
      <img
        ...
        alt="Awan Kanan"
        className="absolute top-2 xs:top-4 sm:top-6 md:top-8 right-2 xs:right-4 sm:right-6 w-[70px] xs:w-[100px] sm:w-[140px] md:w-[200px] lg:w-[240px] opacity-70 sm:opacity-80 animate-[cloudMove_40s_linear_infinite_reverse]"
      />
      ...
      <div className="relative z-20 flex flex-col items-center text-center space-y-3 xs:space-y-4 sm:space-y-6 md:space-y-8 max-w-xs xs:max-w-sm sm:max-w-2xl md:max-w-4xl lg:max-w-5xl mx-auto px-2">
        ...
        <img
          ...
          alt="ORMIK Logo"
          className="w-16 xs:w-18 sm:w-20 md:w-24 lg:w-32"
        />
        {/* Title */}
        <img
          src="/assets/hero/hero-title.svg"
          alt="Ready to Explore"
          className="w-[85%] xs:w-[90%] sm:w-[80%] md:w-[65%] lg:w-[55%] max-w-[280px] xs:max-w-[320px] sm:max-w-md md:max-w-lg"
        />
        {/* Button */}{" "}
      ...
      <img
        ...
        alt="asset abstrak"
        className="absolute -bottom-8 sm:-bottom-12 md:-bottom-16 lg:-bottom-20 left-2 sm:left-6 md:left-10 w-[70px] xs:w-[100px] sm:w-[130px] md:w-[160px] lg:w-[200px] z-10 opacity-60 sm:opacity-80"
      />
      <img
        src="/assets/hero/asset-abstrak.svg"
        alt="asset abstrak"
        className="absolute -bottom-8 sm:-bottom-12 md:-bottom-16 lg:-bottom-20 right-2 sm:right-6 md:right-10 w-[70px] xs:w-[100px] sm:w-[130px] md:w-[160px] lg:w-[200px] z-10 opacity-60 sm:opacity-80"
      />
